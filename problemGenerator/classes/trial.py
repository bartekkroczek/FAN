...
class Trial:
    ...
    def create_matrix_a(self):
        ...
        for name in self.figures[:self.figures_list_len]:
            ...
            figures_list.append(Figure([name, figure_rotation, figure_brightness, figure_frame]))
    ...
    def create_matrix_c(self):
        ...
        for idx, name in enumerate(self.figures[:self.figures_list_len]):
            ...
            figures_list_c.append(Figure([name, c_figure_rotation, c_figure_brightness, c_figure_frame]))
